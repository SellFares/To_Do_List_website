...
const TodoList = () => {
    ...
    const handleAddTodo = () => {
        if ( headingInput.trim !== '' ){
            ...
            // ...      : keeps all current items.
            // heading  : the text from the input field
            // lists    : an empty array to hold tasks under that heading
            setHeadingInput('');
        }
    };
    ...
    const handleDeleteTodo = (index) => {
        ...
        // Remove the todo at the specified index ( remove one element at the specified index )
        ...
        { todos.map( (todo,index) => (      // Iterate over each todo item in the todos array
            <div key={index} className='todo-card'>
                <div className='heading_todo'>
                    ...
                    <button className="delete-button-heading" onClick={handleDeleteTodo}>Delete Heading</button>  {/*wala onClick={ () => handleDeleteTodo(index) }*/} 
                </div>
